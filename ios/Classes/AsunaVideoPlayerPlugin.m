...
#import "AsunaVideoPlayerPlugin.h"
...
@interface AsunaVideoPlayerPlugin ()
...
@implementation AsunaVideoPlayerPlugin
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  FlutterMethodChannel* channel =
      [FlutterMethodChannel methodChannelWithName:@"flutter.io/videoPlayer"
                                  binaryMessenger:[registrar messenger]];
  AsunaVideoPlayerPlugin* instance = [[AsunaVideoPlayerPlugin alloc] initWithRegistrar:registrar];
